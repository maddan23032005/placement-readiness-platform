            ...
            <div key={test.id} className="card p-5 flex items-center gap-5">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <p className="text-sm font-semibold text-[hsl(var(--text-primary))] truncate">{test.title}</p>
                ...
                <p className="text-xs text-[hsl(var(--text-muted))]">
                  ...
                  {test.batches.map((b) => b.batch.name).join(", ")} ·{" "}
                  {test._count.attempts} submission{test._count.attempts !== 1 ? "s" : ""} ·{" "}
